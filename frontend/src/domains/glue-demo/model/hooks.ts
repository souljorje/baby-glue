...
const mascotMessageMap: Record<MascotStep, string> = {
  ...
  claim: 'Step 1: grab your cookie coupons so you have something to play with!',
  deposit: 'Step 2: bake cookies and fill the Magic Jar. Bigger jar = bigger share!',
  unglue: 'Step 3: crumble a coupon to grab your fair share of cookies from the jar.',
